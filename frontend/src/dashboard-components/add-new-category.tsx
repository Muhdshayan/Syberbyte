...
export default function AddCategory() {
  // State for dropdowns (for demonstration)
    ...
    <div className="md:w-[25%] w-full bg-cream shadow-none !font-inter-regular py-5">
      ...
      <CardContent className="!font-inter-regular mt-6 flex flex-col gap-4">
       ...
       <div>
        ...
        <div>
          ...
          <Input id="skills" placeholder="Select Skills" className="w-full mt-2 bg-white" />
      ...
      <CardFooter className="mt-6 flex flex-col gap-5">
        <Button className="w-full !bg-blue">
          <Plus className="w-4 h-4" /> Create Job Category
        </Button>
